"""
Experiment 3: Deeper CNN with AdamW & Adjusted Regularization
-------------------------------------------------------------
Architecture:
- 5 Convolutional blocks (32 -> 64 -> 128 -> 256 -> 512 channels)
- Kernel size: 3x3, Padding: 1, MaxPool: 2x2
- Global Adaptive AvgPool + Dropout(0.4) + Linear(512 -> 38 classes)
...
def main():
    parser = argparse.ArgumentParser(description="Deeper CNN AdamW Experiment")
    ...
    if args.train:
        ...
        print(f"   python -m src.experiments.deeper_cnn_adamw --train\n")
