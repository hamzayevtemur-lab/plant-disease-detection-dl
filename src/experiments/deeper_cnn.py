...
- Global Adaptive AvgPool + Dropout(0.5) + Linear(512 -> 38 classes)
...
def main():
    parser = argparse.ArgumentParser(description="Deeper CNN Experiment")
    ...
    if args.train:
        ...
        print(f"   python -m src.experiments.deeper_cnn --train\n")
